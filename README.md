- [:blue_heart:통합 의류 관리 서비스 README](#blue_heart통합-의류-관리-서비스-readme)
  - [프로젝트 소개](#프로젝트-소개)
  - [개발 기간](#개발-기간)
  - [팀원](#팀원)
  - [1. 개발 환경](#1-개발-환경)
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| <img title="" src="./img/profile/김영래.jpg" alt="" width="413px" height="531px"> | <img title="" src="./img/profile/김승희.JPEG" alt="" width="0px" height="0px"> | <img title="" src="./img/profile/김지현.png" alt="" width="0px" height="0px"> | <img title="" src="./img/profile/배상훈.jpg" alt="" width="0px" height="0px"> | <img title="" src="./img/profile/이호성.jpg" alt="" width="0px" height="0px"> | <img title="" src="./img/profile/황성재.jpg" alt="" width="0px" height="0px"> |
...
|:--------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------:|:------------------------------------------------------------------------------------:|
| <img title="" src="./img/mobile//mobile_6.png" alt="" width="" data-align="center">                      | <img title="" src="./img/mobile//mobile_12.png" alt="" width="350px" > | <img title="" src="./img/mobile//mobile_11.png" alt="" width="150px"  >              |
...
| 옷 상세 정보 수정                                                                                                                           | 내 옷장 보기                                        | 옷 상세 보기                                                                                                                                                                                                                                                                                       |
|:------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| ![옷 정보 수정](./img/mobile/mobile_7.png)                                                                                                | ![일정 보기](./img/mobile/mobile_1.png)            | ![일정 등록](./img/mobile/mobile_10.png)                                                                                                                                                                                                                                                          |
...
|:------------------------------------------------------------------------------------:|:-----------------------------------------:|:-----------------------------------------------------------:|
| ![옷장에서 코디 고르기](./img/mobile/mobile_3.png)                                            | ![과거 코디에서 고르기](./img/mobile/mobile_9.png) | ![코디 추천 받기](./img/mobile/mobile_13.png)                     |
| - 사용자의 옷을 바탕으로 코디를 직접 완성한다.<br/>  <br/>- 상단 부분은 사용자가 드래그를 통해 코디의 미리보기 이미지를 만드는 기능이다. | 사용자의 코디 로그를 이용해 코디를 완성한다.                 | 전체 사용자의 데이터를 기반으로 학습된 AI를 바탕으로 일정/날씨/성별/연령 에 따라 코디를 추천 받는다. |

| 코디 태그                                                      | 완성 코디 보기 & 현재 위치 추적하기                                                      | 옷 상태 확인                                                                                |
|:----------------------------------------------------------:|:--------------------------------------------------------------------------:|:--------------------------------------------------------------------------------------:|
| ![코디 태그](./img/mobile/mobile_8.png)                        | ![완성 코디 보기 & 현재 위치 추적하기](./img/mobile/mobile_2.png)                        | ![옷 상태 확인](./img/mobile/mobile_4.png)                                                  |
...
|:---------------------------------------:|:-----------------------------------:|:--------------------------------------------------------------------------------------:|
| ![등록된 코디 확인](./img/mobile/mobile_5.png) | ![모아보기](./img/mobile/mobile_15.gif) |                                                                                        |
| 일정과 코디가 등록된 경우이다.                       | 세탁기나 에어드레서에 담긴 옷들을 확인 가능하다.         | - 위치에 대한 안내글을 클릭하면 다음과 같은 팝업이 나온다.<br/>  <br/>- 마지막으로 세탁한 날짜와 마지막 세탁 이후 착용 횟수를 볼 수 있다. |
